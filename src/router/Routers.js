...
import Chat from '../pages/chatroom/Chat/Chat'
import Chatcard from '../pages/chatroom/Chatcard'
import Chatcards from '../pages/chatroom/Chatcards'
const Routers = () => {
   ...
   return (
      <Routes>
         ...
         <Route path='/chatcards' element={<Chatcards />} /> 
         </>
         :
         <>
         <Route path='/' element={<Navigate to='/home'/>} />
         ...
         <Route path='/chatroom' element={<Navigate to='/login/emailpassword'/>} />
         <Route path='/chatcard' element={<Navigate to='/login/emailpassword'/>} />
         <Route path='/chatcards' element={<Navigate to='/login/emailpassword'/>} /> 
         </>}
      </Routes>
   )
}
